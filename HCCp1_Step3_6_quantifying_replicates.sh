...
#$ -cwd
#$ -e HCCp1_Step3_6_quantifying_replicates.STDOUT.log
#$ -o HCCp1_Step3_6_quantifying_replicates.STDERR.log
# shell for qsub to use:
#$ -S /bin/bash
# name for the job; used by qstat
#$ -N HCCp1_Step3_6_quantifying_replicates
...
# Example
# qsub HCCp1_Step3_6_quantifying_replicates "param1 param2 param3 .."
######################################################
...
Rscript ~/HCC_paper1/Analysis_Scripts/Rscript_HCCp1_Step3_6_quantifying_replicates.R
