...
adata = ad.read_h5ad("/lustre/home/koelschnj/WDt2024.h5ad")
...
adata.uns['liana_res'].to_csv('LIANA_res_WDt2024.csv', index=False)
...
my_plot.save("dotplotfilteredWDt2024.png")
...
adj_my_plot.save("p9dotplotfilteredWDt2024.png")
...
my_plot1.save("dotplotFn1WDt2024.png")
...
adj_my_plot1.save("p9Fn1dotplotfilteredWDt2024.png")
...
adj_my_plot2.save("p9S10dotplotfilteredWDt2024.png")
