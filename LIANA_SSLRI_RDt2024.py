...
adata = ad.read_h5ad("/lustre/home/koelschnj/RDt2024.h5ad")
...
adata.uns['liana_res'].to_csv('LIANA_res_RDt2024.csv', index=False)
...
my_plot.save("dotplotfilteredRDt2024.png")
...
adj_my_plot.save("p9dotplotfilteredRDt2024.png")
...
my_plot1.save("dotplotFn1RDt2024.png")
...
adj_my_plot1.save("p9Fn1dotplotfilteredRDt2024.png")
...
adj_my_plot2.save("p9S10dotplotfilteredRDt2024.png")
