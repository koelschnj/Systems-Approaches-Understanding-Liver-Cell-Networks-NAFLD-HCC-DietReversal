...
#$ -cwd
#$ -e HCCp1_Step1_QC_Filtering.STDOUT.log
#$ -o HCCp1_Step1_QC_Filtering.STDERR.log
# shell for qsub to use:
#$ -S /bin/bash
# name for the job; used by qstat
#$ -N HCCp1_Step1_QC_Filtering
...
# Example
# qsub HCCp1_Step1_QC_Filtering  "param1 param2 param3 .."
######################################################
...
Rscript ~/HCC_paper1/Analysis_Scripts/Rscript_HCCp1_Step1_QC_Filtering.R
