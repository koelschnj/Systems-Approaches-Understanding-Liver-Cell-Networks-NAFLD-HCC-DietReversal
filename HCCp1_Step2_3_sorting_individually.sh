...
#$ -cwd
#$ -e HCCp1_Step2_3_sorting_individually.STDOUT.log
#$ -o HCCp1_Step2_3_sorting_individually.STDERR.log
# shell for qsub to use:
#$ -S /bin/bash
# name for the job; used by qstat
#$ -N HCCp1_Step2_3_sorting_individually
...
# Example
# qsub HCCp1_Step2_3_sorting_individually "param1 param2 param3 .."
######################################################
...
Rscript ~/HCC_paper1/Analysis_Scripts/Rscript_HCCp1_Step2_3_sorting_individually.R
