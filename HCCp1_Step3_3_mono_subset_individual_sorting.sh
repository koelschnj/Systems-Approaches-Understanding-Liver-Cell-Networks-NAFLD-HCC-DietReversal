...
#$ -cwd
#$ -e HCCp1_Step3_3_mono_subset_individual_sorting.STDOUT.log
#$ -o HCCp1_Step3_3_mono_subset_individual_sorting.STDERR.log
# shell for qsub to use:
#$ -S /bin/bash
# name for the job; used by qstat
#$ -N HCCp1_Step3_3_mono_subset_individual_sorting
...
# Example
# qsub HCCp1_Step3_3_mono_subset_individual_sorting "param1 param2 param3 .."
######################################################
...
Rscript ~/HCC_paper1/Analysis_Scripts/Rscript_HCCp1_Step3_3_mono_subset_individual_sorting.R
